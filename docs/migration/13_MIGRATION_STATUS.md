...
premesteno iz bocnog panela (`.cashbook-lock-note`, prikazivalo se samo kad nema smene) u gornji filter red pored dugmeta za osvezavanje ("gore desno"); vidljivost/disabled logika (`updateDesktopDirectActionsVisibility_`) ostaje ista, samo je markup lokacija promenjena.
