 ...
 *
 * Keep private production IDs out of source control unless the deployment owner
 * intentionally configures this project copy for one known environment.
 */
const APP_NAME = 'BLAGAJNA WEB';
const APP_VERSION = '2.0.33-pending-payment-status-hotfix';
const ENVIRONMENT = 'PILOT'; // DEV, PILOT, PROD
const DEBUG_MODE = false;
const DATABASE_SPREADSHEET_ID = '';
const SPREADSHEET_ID = DATABASE_SPREADSHEET_ID;
...
const APP_CONFIG = Object.freeze({
  ...
  DEVELOPMENT_MODE: ENVIRONMENT === 'DEV',
  DEBUG_MODE: DEBUG_MODE,
  DOCUMENT_ROOT_FOLDER_ID: DOCUMENT_ROOT_FOLDER_ID,
  DOCUMENT_ROOT_FOLDER_NAME: DOCUMENT_ROOT_FOLDER_NAME,
  BACKUP_ROOT_FOLDER_ID: BACKUP_ROOT_FOLDER_ID,
  BACKUP_ROOT_FOLDER_NAME: BACKUP_ROOT_FOLDER_NAME
});
...
const CASH_EVENT_TYPES = Object.freeze({
  ...
  TREASURY_HANDOVER: 'TREASURY_HANDOVER',
